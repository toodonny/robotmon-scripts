REM .\bin\adb connect emulator-5562           /sdcard/Robotmon/scripts/com.donny.wargame/
.\bin\adb -s emulator-5562 shell rm -r /sdcard/Robotmon/scripts/com.donny.wargame/images
.\bin\adb -s emulator-5562 shell rm -r /sdcard/Robotmon/scripts/com.donny.wargame/*.*
.\bin\adb -s emulator-5562 shell rm -r /sdcard/Robotmon/scripts/com.donny.wargame/ggscript
